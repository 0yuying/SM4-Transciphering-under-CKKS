...
func TestBootstrapCmplxThenDivideRequiresXBOOT(t *testing.T) {
	eval := Evaluator{Mod1Parameters: mod1.Parameters{Mod1Type: mod1.CosDiscrete}}

	_, _, err := eval.BootstrapCmplxThenDivide(nil, nil)
	require.ErrorContains(t, err, "mod1.CosDiscreteXBOOT")
}
